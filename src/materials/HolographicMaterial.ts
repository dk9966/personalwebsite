...
export default class HolographicMaterial extends ShaderMaterial {
  ...
  constructor(parameters: HolographicMaterialParameters = {}) {
    ...
    super({
      uniforms: {
        ...
        fresnelAmount: { value: parameters.fresnelAmount ?? 0.45 },
        scanlineSize: { value: parameters.scanlineSize ?? 8.0 },
        hologramBrightness: { value: parameters.hologramBrightness ?? 1.0 },
        signalSpeed: { value: parameters.signalSpeed ?? 1.0 },
        hologramColor: {
          value: new Color(parameters.hologramColor ?? "#00d5ff"),
        },
        enableBlinking: { value: parameters.enableBlinking ?? true },
        blinkFresnelOnly: { value: parameters.blinkFresnelOnly ?? true },
